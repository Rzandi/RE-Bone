  ...
  5: [
    {
      ...
      effect: (p) => { p.multipliers.str = (p.multipliers.str || 1) + 0.1; }
    },
    {
      id: "evo_vit",
      name: "Endurance Training",
      desc: "VIT +10% (Multiplicative)",
      effect: (p) => { p.multipliers.vit = (p.multipliers.vit || 1) + 0.1; }
    },
    {
      id: "evo_int",
      name: "Mental Focus",
      desc: "INT +10% (Multiplicative)",
      effect: (p) => { p.multipliers.int = (p.multipliers.int || 1) + 0.1; }
    },
    {
      id: "evo_reflex",
      name: "Cat Reflexes",
  ...
  10: [
    {
      ...
      name: "Titan's Grip",
      desc: "Final DMG +15%",
      effect: (p) => { p.multipliers.dmg = (p.multipliers.dmg || 1) + 0.15; }
    },
    {
      id: "evo_iron",
      name: "Iron Skin",
      desc: "Final DEF +15%",
      effect: (p) => { p.multipliers.def = (p.multipliers.def || 1) + 0.15; }
    },
    {
      id: "evo_vamp",
      name: "Bloodlust",
...
/* =========================================
   CLASS MUTATION TREES
   3 Paths x 3 Tiers (Lv 20, 50, 80)
   ========================================= */
...
window.CLASS_TREES = CLASS_TREES;
