...
export const SocialManager = {
  ...
  // Check if current session should be a daily challenge
  isDailyChallenge() {
      // Logic to check if user requested daily run
      // For now, return false or check a global flag if needed
      return window._startDaily === true;
  },
